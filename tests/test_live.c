...
int main(void) {
    ...
    llm_message_t messages[] = {{LLM_ROLE_USER, "What is 2+2?", 11, NULL, 0, NULL, 0, NULL, 0, NULL, 0}};
    ...
    const char* tooling =
        ...
        "\"required\":[\"location\"]}}}]}";
    llm_message_t tool_messages[] = {
        {LLM_ROLE_USER, "What is the weather in London?", 30, NULL, 0, NULL, 0, NULL, 0, NULL, 0}};
